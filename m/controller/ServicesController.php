<?php
    ...
    class ServicesController extends Controller {
        ...
        public $uses = array('User','Service','Category','Subcategory','Card','Call','Rating','Availability','Rib');
        ...
        public function create() {
            ...
            $d['subcategories'] = $this->Subcategory->findBy(array('conditions'=>array('category_id'=>1)));
            $d['user'] = current($user);
        ...
        public function calls($id) {
            ...
            foreach ($d['calls'] as $k=>$v) {
                ...
                $v->Call->customer = $user->first_name;
                ...
                $v->Call->reel = number_format((($v->Call->benefit/1.196)* $pourcentage),2).' €';
            }
            ...
            foreach ($years as $year) {
                ...
                foreach ($months as $month) {
                    ...
                    if ($calls) {
                        ...
                        $pourcentage = '.'.$d['service']->pourcentage;
                        $d['years'][$year][$month]->reel = number_format((($benefit/1.196)* $pourcentage),2).' €';
                    }
                }
            }
        ...
        public function view($cat,$subcat,$slug,$id) {
            ...
            $d['description_for_layout'] = $username. ' experts en '.$d['category']->title.' '.$d['subcategory']->title.' - '. substr($d['service']->description,0,50);
