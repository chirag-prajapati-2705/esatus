	...
	<body>
	   ...
	   if(isset($_POST['submit'])){
			...
			if($envoayer == "non"){
				...
				echo '<div style="font-size: 30px;color: #3c763d;font-weight: bold;text-align: center;">Vos infos on été ajoutées.</div>'; 
					...
					<div class="row bloc_2_1">
						<form class="form-horizontal" action="" method="post">
							...
							<div class="form-group">
                                                            <label for="nom" class="col-sm-4 control-label form-label">Votre Nom <span style="color: red;" >*</span> :</label>
								<div class="col-sm-8">
										<input type="text" class="form-control" id="nom" name="nom" required>
								</div>
							</div>
							<div class="form-group">
								<label for="prenom" class="col-sm-4 control-label form-label"required>Votre Prénom <span style="color: red;" >*</span>:</label>
								<div class="col-sm-8">
										<input type="text" class="form-control" id="prenom" name="prenom" required>
								</div>
							</div>
							<div class="form-group">
								<label for="email" class="col-sm-4 control-label form-label">Votre Email <span style="color: red;" >*</span>:</label>
								<div class="col-sm-8">
										<input type="email" class="form-control" id="email" name="email" required>
								</div>
							</div>
                                                        <div class="form-group">
								<label for="telephone" class="col-sm-4 control-label form-label">Votre Téléphone <span style="color: red;" >*</span>:</label>
								<div class="col-sm-8">
                                                                    <input type="text" class="form-control" id="email" name="telephone" required>
								</div>
							</div>
                                                        <div class="form-group">
								<label for="password" class="col-sm-4 control-label form-label">Votre mot de passe <span style="color: red;" >*</span>:</label>
								<div class="col-sm-8">
							...
							<h3 class="form-title">Posez votre question <span style="color: red;" >*</span></h3>
							<p class="text_notif">Attention : expliquez bien votre situation et posez une question complète et précise afin de recevoir  une réponse de qualité.
									<textarea class="form-control" rows="3" id="comments" name ="comments" required></textarea>
							</p>							
							<!--<p class="text_notif">
									<img src="captcha.php"/>
