              				...
              				<ul class="nav">
                				...
                				<li>
                  					...
                  					<ul>
					                    ...
					                    <li>
					                      	<a href="<?= Router::url('admin/admins/ribs'); ?>">RIBs</a>
					                    </li>
                    					<li>
					                    ...
					                    <li>
					                      	<a href="<?= Router::url('admin/admins/calls_rib'); ?>">Appels (RIB)</a>
					                    </li>
                                                            <li>
					                      	<a href="<?= Router::url('admin/admins/admin_videocalls'); ?>">Appels video</a>
					                    </li>
					                    <li>
					                    ...
					                    <li>
					                      	...
					                      	<a href="<?= Router::url('admin/admins/promo'); ?>">Promotions</a>
                                                            ...
                                                            <li>
					                      	<a href="<?= Router::url('admin/admins/partner'); ?>">Partenaire</a>
					                    </li>
                  					</ul>
                				</li>
              				</ul>
