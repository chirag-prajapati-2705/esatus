...
<div class="container"> 
  <div class="row">
    <div class="span12">
      <h2><?= $v->title; ?> (<?= count($v->subcategories); ?>) <a class="btn btn-info" style="background: #fff;border-bottom: 0;" href="<?= Router::url('admin/admins/catedit/id:'.$v->id); ?>"><small><i class="icon-edit"></i></small></a></h2>
