...
<div class="container">
    <div class="row demo-tiles">
        ...
        <div class="span4">
            <div class="tile">
                <i style="font-size:26px;font-style:normal;color:#333;">
                    CA Brut: <?= $caTotal[date('Y')][date('n')] ?> €
                    <br><br>
                    CA Net: <?= $years[date('Y')][date('n')]->reel; ?>
                </i>
                <h3 class="tile-title">
                    CA <?= month(date('n')) . ' ' . date('Y'); ?>
                </h3>
            </div>
        </div>
        <div class="span4">
                ...
                <tbody>
                    ...
                    <?php foreach ($months as $month => $stats): ?>
                        <tr>
                            ...
                            <td class="white"><a href="administration/appels/month/<?= $year ?>/<?= $month ?>"><?= $stats->count; ?></a></td>
