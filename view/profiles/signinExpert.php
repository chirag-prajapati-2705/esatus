    		...
    		<form action="<?= Router::url('profiles2/signin2'); ?>" method="post">
                <div class="form-group">
                    ...
                    $this->Form->input(array(
                        'type' => 'hidden', 'name' => 'affiliation', 'label' => '', 'addClass' => 'login-field-icon', 'options' => array()
                    ));
                    ?>
                </div>
                <div class="form-group">
                ...
                <div class="form-group daten">
                    <div class="row">
                        <div class="col-sm-4">
                            <?=
                            $this->Form->input(array(
                                'type' => 'text', 'name' => 'jj', 'label' => '', 'addClass' => 'login-field-icon', 'options' => array('placeholder' => 'JJ', 'class' => 'form-control login-field')
                            ));
                            ?>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <?=
                            $this->Form->input(array(
                                'type' => 'text', 'name' => 'aa', 'label' => '', 'addClass' => 'login-field-icon', 'options' => array('placeholder' => 'AAAA', 'class' => 'form-control login-field')
                            ));
                            ?>
                        </div>
                    </div>
...
<style>
    body {
        background: url(<?= IMAGE; ?>Fotolia_60416033_M.jpg) top center no-repeat fixed;
    }
    h1.demo-logo{
