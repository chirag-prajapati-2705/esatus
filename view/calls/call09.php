...
<?php if (!isset($result)): ?>
    ...
    <?php else: ?>
        ...
        ?>
                        ...
                        <input type="submit" id="call_button" class="btn btn-primary btn-large btn-block" value="Lancer l'appel">
                      <!--<script type="text/javascript">
                        $("#call_button").click(function(){
                            $("#call_button").removeClass("btn-primary");
                            $("#call_button").addClass("disabled");
                                ...
                                if (response == "RINGING")
                                {
                                    ...
                                    ringing_nre = setInterval(function() {
                                        ...
                                        if (ring_compt == 10)
                                        {
                                            ...
                                            /*$.ajax({
                                             type : "POST",
                                             url : "/availabilities/ajax_empty",
                                             data : {id:"<?php echo $service_id ?>",monday:"",tuesday:"",wednesday:"",thursday:"",friday:"",saturday:"",sunday:""},
