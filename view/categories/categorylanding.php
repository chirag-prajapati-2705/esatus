            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 sub-form">
                            <div id="sub-form" <?php if($this->request->params[0] == 'voyance') echo 'class="hide"';?>>
                            ...
                            <span id="result"></span>
                            <?php if($this->request->params[0] == 'voyance'): ?>
                            <div class="carte-inverses">
                                <div class="carte-inverse"></div>
                                <div class="carte-inverse"></div>
                                <div class="carte-inverse"></div>
                                <div class="carte-inverse"></div>
                            </div>
                    ...
                    <?php if($this->request->params[0] == 'voyance'){ ?>
                     <div class="col-md-6 liste-cartes">
                         <div class="row"> 
