...
?>
                ...
                <h2>Appel vidéo</h2>
                <div class="control-group">
                    <select class="login-field" name="video"> 
                        <option <?php if ($service->video == 1): ?> selected="selected"<?php endif; ?> value="1">Oui</option> 
                        <option <?php if ($service->video == 0): ?> selected="selected"<?php endif; ?> value="0">Non</option>
                    </select>
                </div>
