...
class CallsController extends Controller
{
    ...
    public function call_to_user($user_phone,$expert_number){
        ...
        //$userPhone = '+918780943817';
        //$encodedSalesPhone = '+919586835318';
    ...
    {
        $api_key=(IS_TEST==true)?'sk_test_Ng4MD288EIRUAGtIkvOuZQnF':'sk_live_IJ10BMsmpRz3vVRoZc9MCz9D';
    ...
    public function get_twilio_credential()
    {
        ...
        if (IS_TEST) {
            $twilio_credetial['sid'] = 'ACb73ab3b76865f05ce3b9755443c3114b';
            $twilio_credetial['token'] = 'ffe4f3de13040f13a4b660fdf4822cc0';
