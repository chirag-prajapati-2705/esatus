...
Router::connect('administration/appels_video','admin/admins/admin_videocalls');
...
Router::connect('administration/categorie/modifier/:id','admin/admins/catedit/id:([0-9]+)');
...
// Partner
Router::connect('administration/partenaire','admin/admins/partner');
Router::connect('administration/ajouter-partenaire','admin/admins/addpartner');
Router::connect('administration/clients-partenaire-liste/:id','admin/admins/clientpartnerliste/id:([0-9]+)');
Router::connect('administration/appels-partenaire-liste/:id','admin/admins/appelspartnerliste/id:([0-9]+)');
...
Router::connect('creer-un-compte/:affiliation','profiles/signin/affiliation:([a-z0-9_\-]+)');
...
//added by andru
Router::connect('espace-client/ma-rib','users/verify_rib');
Router::connect('espace-client/ma-carte','users/verify');
...
Router::connect('deconnexion','profiles/test');


Router::connect('facebook-login','socialmedia/index');
Router::connect('twitter-login','socialmedia/twitter_login');
...
// added by andru
Router::connect('espace-client/my-rib','users/rib');
Router::connect('espace-client/ma-carte-bancaire','users/card');
Router::connect('espace-client/supprimer','users/erase');
Router::connect('espace-client/supprimer-rib','users/eraseRib');
...
//Router::connect('experts/:slug/:source','categories/category/slug:([a-z0-9_\-]+)/source:([a-z0-9_\-]+)');
...
Router::connect('partenaire/connexion','partner/login');
Router::connect('partenaire/deconnexion','partner/logout');
// Dashboard
Router::connect('partenaire','partner/index');

// Clients
Router::connect('partenaire/clients','partner/users');
Router::connect('partenaire/ajouter','partner/adduser');
Router::connect('partenaire/clients/:slug-:id','partner/user/slug:([a-z0-9_\-]+)/id:([0-9]+)');

Router::connect('partenaire/services','partner/services');
Router::connect('partenaire/ajouter-expert','partner/addexpert');
Router::connect('partenaire/services/:slug-:id','partner/service/slug:([a-z0-9_\-]+)/id:([0-9]+)');

Router::connect('partenaire/appels','partner/calls');
Router::connect('partenaire/appels/:id','partner/call/id:([0-9]+)');

Router::connect('partenaire/promo','partner/promo');

Router::connect('partenaire/cbb/:id','partner/cbb/id:([0-9]+)');
Router::connect('partenaire/rib/:id','partner/rib/id:([0-9]+)');
// -------------------------------------------------------------------------------------------
